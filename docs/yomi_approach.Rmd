...
5. Complete steps 3. and 4. until all possible combinations $H^i_j, H^{-i}_l$ are exhausted.
...
7. Minimize the linear equation $s^i\mathbf{A}^i \bar{s}^{-i}$ for $s^i$ under the constraint that $s^i_m \geq 0$ and $\sum_m s^i_m = 1.$
