from yomi_bot.generic_code.arena import Arena
...
class RPSArena(Arena):
    ...
    def evaluate_round_outcome(self, left_card, right_card):
        ...
        left_score, right_score = self.determine_score(winner=winner,
    ...
    def build_outcome_container(self,winner,left_score, right_score, left_card, right_card):
        
        outcome = {'left':{
                    'state': {'score':left_score,
                            'discards':[left_card]}}, 
                'right':{'state': {'score':right_score,
                                    'discards':[right_card]}},
                'winner':winner}
